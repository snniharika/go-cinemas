"use strict";var N=Object.defineProperty;var B=Object.getOwnPropertyDescriptor;var Y=Object.getOwnPropertyNames;var G=Object.prototype.hasOwnProperty;var v=n=>{throw TypeError(n)};var U=(n,a)=>{for(var t in a)N(n,t,{get:a[t],enumerable:!0})},V=(n,a,t,i)=>{if(a&&typeof a=="object"||typeof a=="function")for(let s of Y(a))!G.call(n,s)&&s!==t&&N(n,s,{get:()=>a[s],enumerable:!(i=B(a,s))||i.enumerable});return n};var F=n=>V(N({},"__esModule",{value:!0}),n);var L=(n,a,t)=>a.has(n)||v("Cannot "+t);var o=(n,a,t)=>(L(n,a,"read from private field"),t?t.call(n):a.get(n)),d=(n,a,t)=>a.has(n)?v("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(n):a.set(n,t),u=(n,a,t,i)=>(L(n,a,"write to private field"),i?i.call(n,t):a.set(n,t),t),R=(n,a,t)=>(L(n,a,"access private method"),t);var $={};U($,{Attributes:()=>e,Events:()=>f.Events,MediaError:()=>r.MediaError,MuxVideoBaseElement:()=>D,generatePlayerInitTime:()=>r.generatePlayerInitTime,playerSoftwareName:()=>P,playerSoftwareVersion:()=>C});module.exports=F($);var r=require("@mux/playback-core");var W=()=>{try{return"0.27.2"}catch{}return"UNKNOWN"},w=W(),x=()=>w;var f=require("custom-media-element");var K=`
<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" part="logo" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2" viewBox="0 0 1600 500"><g fill="#fff"><path d="M994.287 93.486c-17.121 0-31-13.879-31-31 0-17.121 13.879-31 31-31 17.121 0 31 13.879 31 31 0 17.121-13.879 31-31 31m0-93.486c-34.509 0-62.484 27.976-62.484 62.486v187.511c0 68.943-56.09 125.033-125.032 125.033s-125.03-56.09-125.03-125.033V62.486C681.741 27.976 653.765 0 619.256 0s-62.484 27.976-62.484 62.486v187.511C556.772 387.85 668.921 500 806.771 500c137.851 0 250.001-112.15 250.001-250.003V62.486c0-34.51-27.976-62.486-62.485-62.486M1537.51 468.511c-17.121 0-31-13.879-31-31 0-17.121 13.879-31 31-31 17.121 0 31 13.879 31 31 0 17.121-13.879 31-31 31m-275.883-218.509-143.33 143.329c-24.402 24.402-24.402 63.966 0 88.368 24.402 24.402 63.967 24.402 88.369 0l143.33-143.329 143.328 143.329c24.402 24.4 63.967 24.402 88.369 0 24.403-24.402 24.403-63.966.001-88.368l-143.33-143.329.001-.004 143.329-143.329c24.402-24.402 24.402-63.965 0-88.367s-63.967-24.402-88.369 0L1349.996 161.63 1206.667 18.302c-24.402-24.401-63.967-24.402-88.369 0s-24.402 63.965 0 88.367l143.329 143.329v.004ZM437.511 468.521c-17.121 0-31-13.879-31-31 0-17.121 13.879-31 31-31 17.121 0 31 13.879 31 31 0 17.121-13.879 31-31 31M461.426 4.759C438.078-4.913 411.2.432 393.33 18.303L249.999 161.632 106.669 18.303C88.798.432 61.922-4.913 38.573 4.759 15.224 14.43-.001 37.214-.001 62.488v375.026c0 34.51 27.977 62.486 62.487 62.486 34.51 0 62.486-27.976 62.486-62.486V213.341l80.843 80.844c24.404 24.402 63.965 24.402 88.369 0l80.843-80.844v224.173c0 34.51 27.976 62.486 62.486 62.486s62.486-27.976 62.486-62.486V62.488c0-25.274-15.224-48.058-38.573-57.729" style="fill-rule:nonzero"/></g></svg>`;var e={BEACON_COLLECTION_DOMAIN:"beacon-collection-domain",CUSTOM_DOMAIN:"custom-domain",DEBUG:"debug",DISABLE_TRACKING:"disable-tracking",DISABLE_COOKIES:"disable-cookies",DISABLE_PSEUDO_ENDED:"disable-pseudo-ended",DRM_TOKEN:"drm-token",PLAYBACK_TOKEN:"playback-token",ENV_KEY:"env-key",MAX_RESOLUTION:"max-resolution",MIN_RESOLUTION:"min-resolution",RENDITION_ORDER:"rendition-order",PROGRAM_START_TIME:"program-start-time",PROGRAM_END_TIME:"program-end-time",ASSET_START_TIME:"asset-start-time",ASSET_END_TIME:"asset-end-time",METADATA_URL:"metadata-url",PLAYBACK_ID:"playback-id",PLAYER_SOFTWARE_NAME:"player-software-name",PLAYER_SOFTWARE_VERSION:"player-software-version",PLAYER_INIT_TIME:"player-init-time",PREFER_CMCD:"prefer-cmcd",PREFER_PLAYBACK:"prefer-playback",START_TIME:"start-time",STREAM_TYPE:"stream-type",TARGET_LIVE_WINDOW:"target-live-window",LIVE_EDGE_OFFSET:"live-edge-offset",TYPE:"type",LOGO:"logo"},H=Object.values(e),C=x(),P="mux-video",E,g,T,m,_,p,O,I,M,b,c,y,D=class extends f.CustomVideoElement{constructor(){super();d(this,c);d(this,E);d(this,g);d(this,T);d(this,m,{});d(this,_,{});d(this,p);d(this,O);d(this,I);d(this,M);d(this,b,"");u(this,T,(0,r.generatePlayerInitTime)()),this.nativeEl.addEventListener("muxmetadata",t=>{var l;let i=(0,r.getMetadata)(this.nativeEl),s=(l=this.metadata)!=null?l:{};this.metadata={...i,...s},(i==null?void 0:i["com.mux.video.branding"])==="mux-free-plan"&&(u(this,b,"default"),this.updateLogo())})}static get NAME(){return P}static get VERSION(){return C}static get observedAttributes(){var t;return[...H,...(t=f.CustomVideoElement.observedAttributes)!=null?t:[]]}static getLogoHTML(t){return!t||t==="false"?"":t==="default"?K:`<img part="logo" src="${t}" />`}static getTemplateHTML(t={}){var i;return`
