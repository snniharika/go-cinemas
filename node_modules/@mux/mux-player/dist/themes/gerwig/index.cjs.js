...
var _onKeyDown;
var _onMenuClick;
function getTemplateHTML8(_attrs) {
  return (
    /*html*/
    `
      ${MediaChromeMenu.getTemplateHTML(_attrs)}
...
var MediaContextMenu = class extends MediaChromeMenu {
  constructor() {
    super();
    __privateAdd13(this, _updateVisibility);
    __privateAdd13(this, _closeContextMenu);
    __privateAdd13(this, _closeOtherContextMenus);
    __privateAdd13(this, _isVideoContainer);
    __privateAdd13(this, _onContextMenu);
    __privateAdd13(this, _isContextMenuOpen, false);
    __privateAdd13(this, _onControllerContextMenu, (event) => {
      const target = event.target;
      const isVideoElement = (target == null ? void 0 : target.nodeName) === "VIDEO";
      const isVideoContainer = __privateMethod9(this, _isVideoContainer, isVideoContainer_fn).call(this, target);
      if (isVideoElement || isVideoContainer) {
        if (!__privateGet13(this, _isContextMenuOpen)) {
          __privateMethod9(this, _onContextMenu, onContextMenu_fn).call(this, event);
        } else {
          __privateMethod9(this, _closeContextMenu, closeContextMenu_fn).call(this);
        }
      }
    });
    __privateAdd13(this, _onDocumentClick, (event) => {
      const target = event.target;
    ...
    __privateAdd13(this, _onKeyDown, (event) => {
      if (event.key === "Escape") {
        __privateMethod9(this, _closeContextMenu, closeContextMenu_fn).call(this);
      }
    });
    __privateAdd13(this, _onMenuClick, (event) => {
      var _a3, _b2;
      const target = event.target;
    ...
    __privateMethod9(this, _updateVisibility, updateVisibility_fn).call(this);
  }
  connectedCallback() {
    super.connectedCallback();
    getMediaController(this).addEventListener(
      "contextmenu",
      __privateGet13(this, _onControllerContextMenu)
    );
    this.addEventListener("click", __privateGet13(this, _onMenuClick));
  }
  disconnectedCallback() {
    super.disconnectedCallback();
    ...
    this.removeEventListener("click", __privateGet13(this, _onMenuClick));
    document.removeEventListener("mousedown", __privateGet13(this, _onDocumentClick));
    document.removeEventListener("keydown", __privateGet13(this, _onKeyDown));
  }
};
_isContextMenuOpen = /* @__PURE__ */ new WeakMap();
_updateVisibility = /* @__PURE__ */ new WeakSet();
updateVisibility_fn = function() {
  this.hidden = !__privateGet13(this, _isContextMenuOpen);
};
_closeContextMenu = /* @__PURE__ */ new WeakSet();
closeContextMenu_fn = function() {
  __privateSet11(this, _isContextMenuOpen, false);
  __privateMethod9(this, _updateVisibility, updateVisibility_fn).call(this);
};
...
closeOtherContextMenus_fn = function() {
  ...
  allContextMenus.forEach((menu) => {
    var _a3;
    if (menu !== this) {
      __privateMethod9(_a3 = menu, _closeContextMenu, closeContextMenu_fn).call(_a3);
    }
  });
};
...
onContextMenu_fn = function(event) {
  event.preventDefault();
  __privateMethod9(this, _closeOtherContextMenus, closeOtherContextMenus_fn).call(this);
  __privateSet11(this, _isContextMenuOpen, true);
  this.style.position = "fixed";
  this.style.left = `${event.clientX}px`;
  this.style.top = `${event.clientY}px`;
  __privateMethod9(this, _updateVisibility, updateVisibility_fn).call(this);
  document.addEventListener("mousedown", __privateGet13(this, _onDocumentClick), {
    once: true
  });
  document.addEventListener("keydown", __privateGet13(this, _onKeyDown), { once: true });
};
_onDocumentClick = /* @__PURE__ */ new WeakMap();
_onKeyDown = /* @__PURE__ */ new WeakMap();
_onMenuClick = /* @__PURE__ */ new WeakMap();
MediaContextMenu.getTemplateHTML = getTemplateHTML8;
...
MediaContextMenuItem.getTemplateHTML = getTemplateHTML9;
