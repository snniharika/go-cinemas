...
class MediaController extends import_media_container.MediaContainer {
  ...
  get noMutedPref() {
    return (0, import_element_utils.getBooleanAttr)(this, Attributes.NO_MUTED_PREF);
  }
  set noMutedPref(value) {
    (0, import_element_utils.setBooleanAttr)(this, Attributes.NO_MUTED_PREF, value);
  }
  ...
  keyboardShortcutHandler(e) {
    ...
    switch (e.key) {
      ...
      case "ArrowUp": {
        ...
        evt = new import_server_safe_globals.globalThis.CustomEvent(import_constants.MediaUIEvents.MEDIA_VOLUME_REQUEST, {
          composed: true,
          bubbles: true,
          detail
        });
