...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2x1 hover:-translate-y-1 transition duration-300 w-66'>
        <img onClick={()=> {navigate(`/movies/${movie._id}`); scrollTo(0,0)}} src={movie.backdrop_path} alt="" className='rounded-1g h-52 w-full object-cover object-right-bottom cursor-pointer' />
